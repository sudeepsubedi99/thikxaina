...
<body class="font-sans text-white bg-gray-900">
    ...
    <nav class="border-b border-gray-800">
        ...
        {{-- logo here --}}
            <li class="">
                <a href="#" class="">
                 <img class="w-32" src="/img/logo.png" alt="logo" fill="#1a202c" ></img>
                </a>
            </li>
            <li class="mt-3 md:ml-16 md:mt-0 ">
                <a href="#" class="hover:text-gray-300 " fill= "none">Home</a>
            </li>
            <li class="mt-3 md:ml-6 md:mt-0 ">
                <a href="#" class="hover:text-gray-300 ">About</a>
            </li>
            <li class="mt-3 md:ml-6 md:mt-0 ">
                <a href="#" class="hover:text-gray-300 ">Company</a>
            </li>
        </ul>
        <div class="flex flex-col items-center md:flex-row">
            <div class="relative">
                <input type="text" class="w-64 px-8 py-1 pl-8 text-sm bg-gray-800 rounded-full focus:outline-none focus:shadow-outline " placeholder="Search">
                <div class="absolute top-0 "><svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 mt-2 ml-2 text-gray-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
<footer class="mt-12 dark:bg-gray-800">
